class GithubReposModel {
  ...
  GithubReposModel({this.totalCount, this.incompleteResults, this.items});

  GithubReposModel copyWith({List<Items>? items}) {
    return GithubReposModel(items: items ?? this.items);
  }
